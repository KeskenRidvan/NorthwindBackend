...
namespace Northwind.Core.CrossCuttingConcerns.Caching.Concrete.Microsoft;
...
public class MemoryCacheManager : ICacheManager
{
	...
	public void Add(string key, object data, int duration) => _cache.Set(key, data, TimeSpan.FromMinutes(duration));
